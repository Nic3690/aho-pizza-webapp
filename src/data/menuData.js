...
export const menuItems = {
  ...
  'menu-fisso': [
    { 
      id: 120, 
      name: 'Menù Baby', 
      description: '1 Pizza Piccola (Margherita, Rossa, Wurstel, Pazza) + 1 Supplì Semplice o 1 Crocchetta + 1 Bibita da 33 cl.', 
      price: '8 €', 
      allergens: []
    },
    { 
