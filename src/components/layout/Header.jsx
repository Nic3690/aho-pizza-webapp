...
const Header = () => {
  return (
    <header className="bg-red-800 text-white shadow-lg sticky top-0 z-50">
      <div className="container mx-auto px-4 pt-3 pb-2 sm:py-2 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-6">
          <div className="flex flex-col items-end text-sm">
            <p className="text-aho-yellow font-semibold text-sm">Sempre Aperti dalle 18:00 alle 22:00!</p>
            <div className="flex items-center">
              <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
              </svg>
              <span className="text-sm">06 20 630 082</span>
            </div>
            <div className="flex items-center mt-0.5">
              <svg className="w-4 h-4 mr-1" fill="#25D366" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-sm">+39 388 861 0207</span>
            </div>
          </div>
        </div>
      </div>
