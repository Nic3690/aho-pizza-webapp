      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="mb-2">Tel: 0620630082-92</p>
            <p className="mb-2">Cell: 3888610207</p>
          </div>
          <div>
            <h3 className="text-xl font-bold mb-4">Informazioni</h3>
            <p className="mb-2">Dal Lunedì al Venerdì - festivi esclusi</p>
            <p className="mb-2">Sempre Aperti dalle 18:00 alle 22:00!</p>
            <p className="mb-2">Contributo di consegna: 2€</p>
            <p>Ordine minimo 12€</p>
          </div>
          <div>
